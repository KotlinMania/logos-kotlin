# Agent guide - logos-kotlin

This file is the quick-reference operating contract for logos-kotlin. The longer
...
logos-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`logos`](./README.md). Upstream Rust is the behavioral oracle while the
