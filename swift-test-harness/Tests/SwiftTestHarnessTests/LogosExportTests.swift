...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Logos.swiftmodule/`
...
//      `import Logos` above would fail at compile time.
//
//   2. The static archive `libLogos.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Logos" }` and
//      `flattenPackage = "io.github.kotlinmania.logos"` configuration in
