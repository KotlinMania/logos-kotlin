...
| `src/commonTest/kotlin/io/github/kotlinmania/logos/source/SourceTest.kt` | `// port-lint: source src/source.rs` | `// port-lint: source source.rs` | `source.rs` | `port-lint provenance header matched only after fallback normalization: 'src/source.rs' vs expected 'source.rs'` |
...
| `src/commonTest/kotlin/io/github/kotlinmania/logos/LogosTest.kt` | `// port-lint: source src/lib.rs` | `// port-lint: source lib.rs` | `lib.rs` | `port-lint provenance header matched only after fallback normalization: 'src/lib.rs' vs expected 'lib.rs'` |
